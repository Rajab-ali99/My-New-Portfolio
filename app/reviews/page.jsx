...
const ReviewsPage = () => {
    return (
        <div className='p-3 md:p-10 relative'>
            <div style={{ zIndex: 0 }} className="fixed inset-0 bg-gradient-to-b from-lime-600/40 via-transparent to-transparent blur-2xl" />
            <section className='z-10 relative'>

                <h1 className='md:text-5xl text-3xl font-semibold pt-20 text-center py-10'>
                ...
                <div className='grid grid-cols-1 gap-5 md:grid-cols-2'>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className=' text-xs md:text-base md:pt-6 pt-3 '>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                <div className="font-semibold text-lime-600 md:text-xl">
                                    —Sara Khan

                                </div>
                                <div className="md:text-lg font-semibold text-slate-500">E-Commerce Owner</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                <div className="font-semibold text-lime-600 text-xl">
                                    —Priya Sanam.

                                </div>
                                <div className="text-lg font-semibold text-slate-500">Boutique Fitness Studio Owner</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500">B2B Service Provider</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500">Former Retail Trader</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500">Crypto Investor</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500">Part-Time Trader</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500">Fashion Brand Owner</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500">Home Goods Founder</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500">Beauty Product Entrepreneur</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500">Tech Startup Founder</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500">Operations Director</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500">E-Commerce Brand Owner</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500">Freelance Software Developer</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500">E-Commerce Entrepreneur</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500"> Digital Marketing Agency Owner</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500">Educational Non-Profit Director</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500">B2B Marketing Agency Owner</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500">Professional Services Founder</div>
                            </div>
                        </div>
                    </div>
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500">Landlord</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500">Toyata Car dealer </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='bg-[#1f1d1d]/60 p-5 flex flex-col justify-between  rounded-4xl'>
                        ...
                        <div className="pt-3 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="text-lg font-semibold text-slate-500">E-commerce products importer </div>
                            </div>
                        </div>
                    </div>
