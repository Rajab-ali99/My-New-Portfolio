...
const AboutPage = () => {
    ...
    return (
        <div className='md:p-10 p-3'>
            ...
            {/* <div className="flex justify-center py-20 items-center flex-col ">
                <span className="text-lime-600 text-sm  font-black px-3 mb-3 py-0.5 rounded-full bg-gray-800">CORE TEAM MEMBERS</span>
            ...
            <div className="md:w-[80vw] flex md:flex-row flex-col gap-10 md:gap-3 md:mx-auto">
                <div className="md:w-1/3  flex flex-col gap-3  ">
                    <div className=" relative p-5 rounded-3xl bg-[#1f1d1d] flex justify-center">
                        ...
                        <div className="absolute top-1/2 -translate-y-1/2 w-72 h-72 rounded-full bg-lime-600/50 blur-3xl z-10" />



                    </div>
                    <div className="bg-[#1f1d1d] flex flex-col items-center p-4 rounded-3xl">
                        <h2 className="text-lime-600 font-extrabold text-2xl">Malik <span className="text-red-500">Asif</span></h2>
                ...
                <div className="md:w-1/3  flex flex-col gap-3  ">
                    ...
                    <div className="bg-[#1f1d1d] flex flex-col items-center p-4 rounded-3xl">
                        <h2 className="text-lime-600 font-extrabold text-2xl">Rajab <span className="text-red-500">Ali</span></h2>
                 ...
                 <div className="md:w-1/3  flex flex-col gap-3  ">
                    ...
                    <div className="bg-[#1f1d1d] flex flex-col items-center p-4 rounded-3xl">
                        <h2 className="text-lime-600 font-extrabold text-2xl">Muhammad <span className="text-red-500">Hamza</span></h2>
